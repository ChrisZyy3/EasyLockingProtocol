...
import (
	...
	"tokenVestingProtocol/plugin/email/utils"
	utils2 "tokenVestingProtocol/utils"

	"tokenVestingProtocol/global"
	"tokenVestingProtocol/service"

	"tokenVestingProtocol/model/system"

	"github.com/gin-gonic/gin"
	"go.uber.org/zap"
)

var userService = service.ServiceGroupApp.UserServiceGroup.UsersService
